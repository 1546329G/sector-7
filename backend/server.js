...
import profesorRoutes from './api1/routes/profesorRoutes.js';
import asistenciaRoutes from './api1/routes/asistenciaRoutes.js';
import horarioFeriadoRoutes from './api1/routes/horarioFeriadoRoutes.js';
import horariosRoutes from './api2/routes/horario.js';
import authRoutes from './api3/src/routes/authRoutes.js';
import userRoutes from './api3/src/routes/userRoutes.js';
...
app.get('/', (req, res) => {
  res.send('API Unificada funcionando!');
});
